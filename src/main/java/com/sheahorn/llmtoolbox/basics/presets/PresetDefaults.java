...
public class PresetDefaults {
    ...
    private static final Map<String, String> SEED = Map.ofEntries(
            Map.entry("daemon",
                    "fs_files_copy_file,fs_files_create,fs_files_delete,fs_files_mkdir,fs_files_move_dir," +
            ...
            Map.entry("builder",
                    "fs_files_copy_file,fs_files_create,fs_files_delete,fs_files_mkdir,fs_files_move_file," +
